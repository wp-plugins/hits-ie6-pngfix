                ...
                _e('<p>I take no credit for the great effort authors have gone into making each method of getting IE6 PNG compatability to work. I just did the work to merge them all into a single wordpress plugin.</p>', $this->localizationDomain);
                    ...
                    <table width="100%" cellspacing="2" cellpadding="5" class="form-table"> 
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="hits_ie6_pngfix_THM_CSSSelector" value="<?php echo $this->options['hits_ie6_pngfix_THM_CSSSelector'] ?>" size="100" /><br /><?php _e('Note: CSS Selector is only used for the Twin Helix methods.', $this->localizationDomain);?></td>
						</tr>
                        <tr>
                    ...
                    <p><?php _e('I was not able to find the original author for SuperSleight, and just found the code searching google. 
                       If anyone knows the original author, please let me know so that proper credit can be given.', $this->localizationDomain);?></p>
                </form>
                <?php
        }
  } //End Class
