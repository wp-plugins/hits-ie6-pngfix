    ...
    class hits_ie6_pngfix {
        ...
        */        
        ...
        function wp_head()
		{
			...
			{
				echo "\n<style type='text/css'>".$this->options['hits_ie6_pngfix_THM_CSSSelector']." { behavior: url(". $this->thispluginurl."THM1/iepngfix.htc) }</style>";
			}
			else if (strcmp($this->options['hits_ie6_pngfix_method'],'THM2')==0)
			{
				echo "\n<style type='text/css'>".$this->options['hits_ie6_pngfix_THM_CSSSelector']." { behavior: url(". $this->thispluginurl."THM2/iepngfix.htc) }</style>";
